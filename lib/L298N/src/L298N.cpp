...
void L298N::stop() {
  digitalWrite(_pinIN1, HIGH);  // BOTH HIGH WIILL DO A MOTOR BRAKE  JD MOD
  digitalWrite(_pinIN2, HIGH);  // BOTH HIGH WIILL DO A MOTOR BRAKE  JD MOD

  // digitalWrite(_pinIN1, HIGH);  // BOTH LOW WIILL DO A MOTOR STOP (BUT NOT BRAKE)  JD MOD
  // digitalWrite(_pinIN2, HIGH);  // BOTH LOW WIILL DO A MOTOR STOP (BUT NOT BRAKE)  JD MOD
